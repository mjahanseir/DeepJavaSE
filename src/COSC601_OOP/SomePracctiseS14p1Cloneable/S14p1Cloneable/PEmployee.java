 ...
 */
public class PEmployee extends PPerson
{
     ...
     */
    public PEmployee(String fName, String lName, int age, int sin, int hoursWorked, double pay ) {
    ...
    public boolean equals( Object obj ) {
        ...
        // test compatibility
        if ( obj instanceof PEmployee) {
            PEmployee emp = (PEmployee)obj;
    ...
    public PEmployee clone() {
        PEmployee copy = (PEmployee) super.clone();
        return copy;
    }
