 ...
 */
public class PPerson implements Cloneable, Comparable<PPerson>{
     ...
     */
    public PPerson(String fName, String lName, int age, int sin) {
        firstName = fName;
        lastName = lName;
    ...
    public boolean equals( Object obj ) {
        ...
        // test compatibility
        if ( obj instanceof PPerson) {
            PPerson p = (PPerson) obj; // cast the object as a person
    ...
    @Override
    public PPerson clone(){

        PPerson copy= null;

        try{
            copy= (PPerson)super.clone();
