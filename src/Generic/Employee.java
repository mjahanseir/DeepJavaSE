...
public class Employee implements Comparable<Employee>, Cloneable{
    ...
    public Employee(int employeeNum, String fName, String lName){
        this(employeeNum, fName, lName, "", "", 0);
        System.out.println("Invoking partial constructor");
    }

    public Employee(int employeeNum, String fName, String lName, String deptCode, String email, double salary) {
