package LiangExcercise10thAll.Exercise_10.Exercise_10_07; /*********************************************************************************
...
*********************************************************************************/
import LiangExcercise10thAll.Exercise_11.Exercise_11_03.Account;
...
public class Exercise_10_07 {
	...
	public static void main(String[] args) {
		...
		LiangExcercise10thAll.Exercise_11.Exercise_11_03.Account[] accounts = new LiangExcercise10thAll.Exercise_11.Exercise_11_03.Account[10];
	...
	public static void initialBalance(LiangExcercise10thAll.Exercise_11.Exercise_11_03.Account[] a) {
		int initialBalance = 100;
		for (int i = 0; i < a.length; i++) {
			a[i] = new LiangExcercise10thAll.Exercise_11.Exercise_11_03.Account(i, initialBalance);
		}
	}
	...
	public static boolean isValidID(int id, LiangExcercise10thAll.Exercise_11.Exercise_11_03.Account[] a) {
		for (int i = 0; i < a.length; i++) {
			if (id == a[i].getId())
				return true;
		}
