...
public abstract class MyAbstractList<E> implements LiangExcercise10thAll.Exercise_24.Exercise_24_02.MyList<E> {
	...
	public boolean addAll(LiangExcercise10thAll.Exercise_24.Exercise_24_02.MyList<E> otherList) {
	...
	@Override /** Removes all the elements in otherList from this list
		* Returns true if this list changed as a result of the call */
	public boolean removeAll(LiangExcercise10thAll.Exercise_24.Exercise_24_02.MyList<E> otherList) {
		boolean changed = false;
		for (int i = 0; i < otherList.size(); i++) {
			E e = otherList.get(i); 
			if (contains(e)) {
