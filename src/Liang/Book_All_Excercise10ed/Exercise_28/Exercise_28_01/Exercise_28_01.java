package LiangExcercise10thAll.Exercise_28.Exercise_28_01;

import LiangExcercise10thAll.Exercise_28.Exercise_28_02.AbstractGraph;
import LiangExcercise10thAll.Exercise_28.Exercise_28_02.Graph;
...
public class Exercise_28_01 {
	public static void main(String[] args) throws Exception {
		...
		ArrayList<LiangExcercise10thAll.Exercise_28.Exercise_28_02.AbstractGraph.Edge> edgeList = new ArrayList<>();
		...
		for (int j = 0; j < NUMBER_OF_VERTICES; j++) {
			...
			for (int i = 1; i < line.length; i++) {
				edgeList.add(new LiangExcercise10thAll.Exercise_28.Exercise_28_02.AbstractGraph.Edge(Integer.parseInt(u),
