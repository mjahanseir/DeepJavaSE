...
// Test 1- Load Customers
        List<Customer> customers= DataLoad.loadCustomer("src/Stream/Company/raf.dat");
        System.out.println(customers.get(2).getName());

// Test 2- Load Products
        List<Product> products= DataLoad.loadProducts("src/Stream/Company/Product.dat");
        System.out.println(products.get(4).getCategory());

// Test 3- Load Order
        List<Order> orders= DataLoad.loadOrders("src/Stream/Company/Orders.dat", customers);
        System.out.println(orders.get(4).getCostomer().getName());

// Test 4
        DataLoad.loadProductOrders(products,orders,"src/Stream/Company/ProductOrders.dat");
        DataLoad.loadOrderProducts(products,orders,"src/Stream/Company/OrderProducts.dat");
